		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"transparent"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					...
					<span :style='{"verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>系统首页</span>
				</el-menu-item> -->
				...
				<el-submenu index="1">
					<template slot="title">
						...
						<span :style='{"verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>个人中心</span>
					</template>
				...
				<el-submenu v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+2+''">
					<template slot="title">
						...
						<span :style='{"verticalAlign":"middle","fontSize":"14px","color":"inherit","textAlign":"center"}'>{{ menu.menu }}</span>
					</template>
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #DBDBDB;
				  				  white-space: nowrap;
				  				  background: url(http://codegen.caihongy.cn/20220805/0e006f92bdc54dbf900e126970416eb9.png) center center no-repeat;
				  				  display: flex;
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						color: #fff;
						background: url(http://codegen.caihongy.cn/20220805/4e3d8eafbc01449a831a12ac77190bf0.png) center center no-repeat;
					}
