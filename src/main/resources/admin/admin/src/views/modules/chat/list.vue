        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"2px solid #33BAE9","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#33BAE9","borderRadius":"30px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
                size="small"
