...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    <el-form
      ...
      label-width="150px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="食材名称" prop="shicaimingcheng">
            <el-input v-model="ruleForm.shicaimingcheng" 
                placeholder="食材名称" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="食材类型" prop="shicaileixing">
            <el-select v-model="ruleForm.shicaileixing" placeholder="请选择食材类型"  >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="食材简介" prop="shicaijianjie">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="食材简介"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="食材用途" prop="shicaiyongtu">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="食材用途"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="食材详情" prop="shicaixiangqing">
            <editor 
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/shicaileixing/shicaileixing', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.shicaileixingOptions = res.data.data;
          }
        });
      },
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('shanshishicai/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('shanshishicai/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('shanshishicai/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
