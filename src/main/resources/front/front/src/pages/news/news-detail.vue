<template>
  <div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    <div class="section-title" :style='{"border":"1px dashed #7e6b5a","margin":"0 0 20px","outline":"1px solid #7e6b5a","color":"#333","outlineOffset":"2px","textAlign":"center","background":"#f6f5f3","fontSize":"20px","lineHeight":"36px"}'>膳食资讯</div>
